...
export default function LuxuryRealEstate() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=Olá,%20vi%20o%20site%20da%20Empreendimento%20em%20Capitólio%20e%20gostaria%20de%20detalhes.`;
      ...
      <div className="bg-stone-50 text-stone-900 font-sans selection:bg-emerald-200 selection:text-emerald-900">
        ...
        >
          <nav className="container mx-auto px-6 flex justify-between items-center">
            ...
            <div className={`hidden md:flex items-center space-x-8 font-medium text-sm tracking-wide ${scrolled ? 'text-stone-600' : 'text-white/90'}`}>
              <a href="#leisure" className="hover:text-emerald-500 transition-colors">A Propriedade</a>
              <a href="#infra" className="hover:text-emerald-500 transition-colors">Infraestrutura</a>
              <a href="#investment" className="hover:text-emerald-500 transition-colors">Investimento</a>
            </div>
        ...
        <main>
          ...
          <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
              <img 
                src="/assets/vista-hero.png" // Certifique-se que esta imagem existe
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-60 animate-bounce">
              <span className="text-[10px] uppercase tracking-widest text-white">Explorar</span>
              <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
            </div>
          </section>
          ...
          <section id="leisure" className="py-24 bg-stone-50">
            <div className="container mx-auto px-6">
               <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
                  ...
                  <p className="text-stone-600 max-w-md w-full text-left leading-relaxed">
                     A área de lazer, que exige maior investimento e engenharia, está 100% funcional. Você compra e já pode desfrutar enquanto finaliza os quartos.
                  </p>
               </div>

               <div className="grid md:grid-cols-3 gap-8">
                  <div className="group relative h-[500px] rounded-2xl overflow-hidden cursor-pointer shadow-lg">
                     ...
                     <div className="absolute bottom-0 left-0 p-8">
                        ...
                        <p className="text-stone-300 text-sm leading-relaxed">
                           Instalada e operante com vista definitiva.
                        </p>
                     </div>
                  </div>

                  <div className="group relative h-[500px] rounded-2xl overflow-hidden cursor-pointer md:-mt-12 shadow-lg">
                     ...
                     <div className="absolute bottom-0 left-0 p-8">
                        ...
                        <p className="text-stone-300 text-sm leading-relaxed">
                           Construção em alvenaria para durabilidade total.
                        </p>
                     </div>
                  </div>
                  ...
                  <div className="group relative h-[500px] rounded-2xl overflow-hidden cursor-pointer shadow-lg">
                     ...
                     <div className="absolute bottom-0 left-0 p-8">
                        ...
                        <p className="text-stone-300 text-sm leading-relaxed">
                           Palmeiras adultas já integradas ao ambiente.
                        </p>
                     </div>
                  </div>
               </div>
          ...
          <section className="relative h-[60vh] md:h-[80vh] bg-black overflow-hidden flex items-center justify-center">
             ...
             <div className="relative z-10 text-center px-6">
                ...
                <button onClick={() => window.open(whatsappLink)} className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-8 py-3 rounded-full hover:bg-white hover:text-black transition-all font-medium">
                   Solicitar Vídeo Completo no WhatsApp
                </button>
             </div>
          </section>

          {/* --- NOVO: INFRAESTRUTURA DO CONDOMÍNIO (FOTOS EXTRAS) --- */}
             ...
             <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                   ...
                   <p className="text-stone-500 max-w-2xl mx-auto">
                      O Colinas do Lago não é apenas um condomínio, é um complexo náutico e aeronáutico completo.
                   </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-auto md:h-[600px]">
                   {/* Foto Principal Grande (Heliponto) */}
                   <div className="relative rounded-2xl overflow-hidden group h-[300px] md:h-full">
                      <img src="/assets/portaria.png" alt="Heliponto" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                      <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors"></div>
                      <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur px-4 py-2 rounded-lg">
                         <p className="font-serif font-bold text-stone-900">Portaria 24h</p>
                      </div>
                   </div>

                   {/* Grid Lateral (Portaria + Geral) */}
                   <div className="grid grid-rows-2 gap-4 h-[600px] md:h-full">
                      <div className="relative rounded-2xl overflow-hidden group">
                         <img src="/assets/heliponto.png" alt="Portaria" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                         <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur px-4 py-2 rounded-lg">
                            <p className="font-serif font-bold text-stone-900">Heliponto Homologado</p>
                         </div>
                      </div>
                      <div className="relative rounded-2xl overflow-hidden group">
                         <img src="/assets/asfalto.jpeg" alt="Condominio" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                         <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur px-4 py-2 rounded-lg">
                            <p className="font-serif font-bold text-stone-900">Asfaltado, energia e água</p>
                         </div>
                      </div>
                   </div>
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/30 bg-emerald-500/10 mb-8">
                    <span className="text-xs font-bold tracking-widest uppercase text-emerald-400">Oportunidade de Barganha</span>
                  </div>
                  <h2 className="font-serif text-4xl md:text-5xl font-medium mb-6 leading-tight">
                    Equity Imediato:<br/>
                    +R$ 2.2 Milhões de margem.
                  </h2>
                  <p className="text-stone-400 text-lg leading-relaxed mb-8 font-light">
                    Ao adquirir por R$ 3.3M e finalizar a obra, o investidor captura o "Gap de Equity" do mercado de luxo de Capitólio, onde o valor de face supera os R$ 5.5M.
                  </p>
                  ...
                  <ul className="space-y-4 mb-10">
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-white">ROI de 67%</h4>
                        <p className="text-sm text-stone-500">Valorização bruta estimada sobre o capital de aquisição.</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
                      <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 mt-1 shrink-0">
                      ...
                      <div>
                        <h4 className="font-bold text-white">Escassez no Condomínio</h4>
                        <p className="text-sm text-stone-500">Últimos lotes com vista definitiva para o "mar de Minas".</p>
                      </div>
                    </li>
                  </ul>

                  <a href={whatsappLink} className="text-emerald-400 font-bold border-b border-emerald-500/30 hover:text-emerald-300 hover:border-emerald-300 transition-colors pb-1 inline-block">
                ...
                <div className="relative">
                  <div className="bg-stone-800/50 backdrop-blur-xl border border-stone-700 rounded-3xl p-8 shadow-2xl">
                    <div className="flex justify-between items-center mb-12 border-b border-stone-700 pb-6">
                      <div>
                        <p className="text-stone-400 text-xs uppercase tracking-wider mb-1">Valorização</p>
                    ...
                    <div className="flex items-end gap-6 h-64 w-full">
                      <div className="w-1/2 flex flex-col justify-end h-full group">
                        <div className="mb-4 text-center">
                          <span className="text-2xl font-bold text-emerald-400 block">R$ 3.3M</span>
                          <span className="text-xs text-stone-500 uppercase tracking-widest">Preço de Barganha</span>
                        </div>
                        {/* Barra proporcional ao valor final */}
                        <div className="w-full bg-stone-700 rounded-t-xl h-[60%] relative overflow-hidden transition-all group-hover:bg-stone-600">
                          <div className="absolute top-0 left-0 w-full h-1 bg-emerald-500/50"></div>
                        </div>
                      </div>
                      <div className="w-1/2 flex flex-col justify-end h-full">
                        <div className="mb-4 text-center">
                          <span className="text-3xl font-bold text-white block">R$ 5.5M</span>
                          <span className="text-xs text-stone-400 uppercase tracking-widest">Valor de Mercado</span>
                        </div>
                        <div className="w-full bg-emerald-600 rounded-t-xl h-[100%] relative overflow-hidden shadow-[0_0_20px_rgba(16,185,129,0.3)]">
          ...
          <section className="py-24 bg-stone-900 text-center px-6">
             <div className="max-w-3xl mx-auto">
                <h2 className="font-serif text-4xl md:text-5xl text-white mb-8">
                   Não compre apenas metros quadrados.<br/>
                ...
                >
                   <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-emerald-600" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M19.001 4.908A8.442 8.442 0 0 0 13.33 2.5c-4.66 0-8.45 3.79-8.45 8.45A8.41 8.41 0 0 0 6.16 15.3l-1.37 4.97 5.12-1.34a8.39 8.39 0 0 0 3.42.72h.01c4.66 0 8.45-3.79 8.45-8.45a8.42 8.42 0 0 0-2.789-6.292ZM13.33 19.46c-.63 0-1.25-.16-1.81-.47l-.13-.08-2.69.7.72-2.61-.09-.14a6.97 6.97 0 0 1-1.07-3.91c0-3.86 3.14-7 7-7s7 3.14 7 7-3.14 7-7 7Zm3.83-5.24c-.21-.1-1.24-.61-1.42-.68-.18-.07-.31-.1-.44.1-.13.21-.5.63-.61.76-.11.12-.23.14-.44.03-.21-.11-.89-.33-1.69-1.04-.63-.56-1.05-1.25-1.18-1.47-.12-.21-.01-.32.09-.42.1-.09.21-.24.32-.37.1-.11.14-.19.21-.32.07-.13.03-.24-.02-.34-.05-.1-.44-1.06-.6-1.45-.16-.38-.32-.33-.44-.34h-.38c-.13 0-.34.05-.52.24-.18.19-.69.67-.69 1.64s.71 1.91.81 2.04c.1.13 1.39 2.12 3.37 2.97.47.2.84.32 1.13.41.48.15.92.13 1.27.08.39-.06 1.24-.51 1.41-1 .17-.5.17-.93.12-1.02-.05-.09-.18-.14-.39-.24Z" />
                   </svg>
        ...
        <footer className="bg-stone-950 text-stone-600 py-12 border-t border-stone-900 text-sm">
           <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="text-right">
                 <p>Contato Direto:</p>
                 <p className="text-white hover:text-emerald-500 cursor-pointer transition-colors">+55 (16) 99720-6578</p>
              </div>
           </div>
        </footer>
